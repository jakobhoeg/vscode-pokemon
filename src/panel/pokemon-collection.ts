			...
			this._pokemonCollection.forEach((potentialFriend) => {
				...
				if (
					potentialFriend.pokemon.left >
						pokemonInCollection.pokemon.left &&
					potentialFriend.pokemon.left <
						pokemonInCollection.pokemon.left +
							pokemonInCollection.pokemon.width
				) {
					...
					if (
						pokemonInCollection.pokemon.makeFriendsWith(
							potentialFriend.pokemon,
						)
					) {
						potentialFriend.pokemon.showSpeechBubble(2000, true);
						pokemonInCollection.pokemon.showSpeechBubble(
							2000,
							true,
						);
					}
